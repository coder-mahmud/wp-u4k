                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 m_m_b_15">
                        <div class="text_section">
                            ...
                            <a href="#" class="yellow_box_shadow hvr-fade fw_700 fz_20">Get involved</a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 single_member">
                        <img class="circled_165" src="<?php echo get_template_directory_uri(); ?>/img/cropped.png" alt="">
                        <h3 class="title fz_25 fw_700">Glenn Farguson AM</h3>
                        <h4 class="designation fz_25 fw_700">Chair</h4>
                        <p class="muse_font">
                            Since being founded in 1995, FC Lawyers has adopted a core value to always be looking for avenues to become invloved and give back to our local comunity.
                        </p>
